...
class SfDateRangePicker extends StatelessWidget {
  ...
  SfDateRangePicker(
      ...
      this.showCancelAndOkButtonOnly = false,
  ...
  final bool showCancelAndOkButtonOnly;
  ...
  Widget build(BuildContext context) {
    return _SfDateRangePicker(
      ...
      showCancelAndOkButtonOnly: showCancelAndOkButtonOnly,
...
class _SfDateRangePickerState extends State<_SfDateRangePicker>
  ...
  Widget _getActionsButton(double top, double actionButtonsHeight) {
    ...
    final Widget actionButtons = widget.showActionButtons
        ? Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                widget.showCancelAndOkButtonOnly
                    ? Expanded(
                        child: TextButton(
                        ...
                        child: Text(
                          widget.cancelText,
                          style: widget.cancelTextStyle == null
    ...
    return Positioned(
      ...
      right: 0,
      height: actionButtonsHeight,
      child: widget.showCancelAndOkButtonOnly
          ? actionButtons
          : Row(
